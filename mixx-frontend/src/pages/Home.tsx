...
const Home: React.FC<HomeProps> = ({
  ...
  const uploadFileToServer = () => {
    ...
    axios
      .post(`${secrets.API_BASE_URL}/upload-file`, formData, {
        headers: {
      ...
      >
        {!dropDownFile ? (
          ...
          >
            ...
            <label htmlFor="video-upload" className="dropdown-list">
        ...
        {progress.show && (
          <div className="progressWrapper">
            <>{console.log(progress.value * 0.01)}</>
            <IonProgressBar
              value={progress.value * 0.01}
              class="progress"
            ></IonProgressBar>
            <div className="progressValue">{`${progress.progressMsg} ${
